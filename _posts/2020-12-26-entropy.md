...
where 
<img src="http://latex.codecogs.com/svg.latex?\mathbf{J}_d" border="0"/> 
is the deterministic current and ___Λ___ is a Gaussian white noise with zero mean and delta function correlation:
